...
const SummaryReport = ({ gender, babyName, kickData }) => {
  ...
  return (
    <>
      <div className="bg-[var(--primary)] text-black p-8 mt-6 max-w-4xl mx-auto rounded-xl tracking-tight font-[Inter]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-[var(--background)] rounded-xl md:col-span-2">
