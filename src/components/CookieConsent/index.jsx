...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed max-w-2/4 bottom-4 left-4 right-4 bg-[#26262B] text-white rounded-lg shadow-lg p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4 z-50">
      <p className="text-sm font-[Poppins] flex flex-wrap text-left items-center space-x-1">
        <img className='size-8' src="/cookies.svg" alt="cookie icon" />
        This site uses cookies to save <span className="text-[var(--primary)]">baby name</span> and <span className="text-[var(--primary)]">kick count</span> data locally. By continuing, you accept cookies.
      </p>
      <button
